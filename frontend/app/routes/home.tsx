...
import { Upload, FileText, Download, X, Loader2, Sparkles, CheckCircle2, AlertCircle } from "lucide-react";
        ...
        <div className="min-h-screen bg-background">
            ...
            <header className="border-b border-border bg-card">
                <div className="max-w-4xl mx-auto px-6 py-4 flex items-center gap-3">
                    ...
                    <div>
                        <h1 className="text-lg font-semibold text-foreground">BPMN Analyzer</h1>
                        <p className="text-sm text-muted-foreground">Upload and analyze business process files</p>
                    </div>
                </div>
            </header>
                ...
                <div className="card-elevated p-6 mb-6">
                    ...
                    {!file ? (
                        ...
                        >
                            ...
                            <span className="text-xs text-muted-foreground">Supports .bpmn and .xml files</span>
                            <input
                                type="file"
                    ...
                    {file && !loading && !hasResults && (
                        <Button onClick={handleUpload} className="w-full mt-4 cursor-pointer">
                ...
                {loading && (
                    <div className="card-elevated p-12 mb-6">
                        <div className="flex flex-col items-center">
                            ...
                            <p className="text-sm font-medium text-foreground mb-1">Analyzing your BPMN file</p>
                            ...
                            <div className="card-elevated">
                                <div className="flex items-center justify-between p-4 border-b border-border">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h3 className="text-sm font-medium text-foreground">Analysis Report</h3>
                                    </div>
                                    <Button
                                        variant="outline"
                                        size="sm"
                            ...
                            <div className="card-elevated">
                                <div className="flex items-center justify-between p-4 border-b border-border">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h3 className="text-sm font-medium text-foreground">Enhanced BPMN</h3>
                                    </div>
                                    <Button
                                        variant="outline"
                                        size="sm"
                                        onClick={() => downloadFile("enhanced.bpmn", enhanced, "application/xml")}
                                    >
                                        <Download className="w-4 h-4 mr-2" />
                                        Download
                                    </Button>
                                ...
                                <div className="p-5 h-100">
                                    <ReactBpmn diagramXML={enhanced} className="w-full h-100" width="100%" />
                                </div>
                            </div>
                        )}
